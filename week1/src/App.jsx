...
const App = () => {
  ...
  return (
    <>
      <div className="flex flex-col h-screen justify-center items-center max-lg:flex-col xax-lg:h-96 duration-300 ">
        <p className=" font-alata text-4xl  my-2">
          We've got a plan that's perfect for you
        </p>
        <p className="font-alata text-4xl flex justify-center items-center flex-col my-2">
          Pick your Premium
        ...
        <div className="flex justify-center h-full">
          {plans.map((plan) => {
            return (
              <div
                key={plan.id}
                className="group shadow-xl flex flex-col h-3/4 justify-center items-center mx-5 cursor-pointer"
              >
                ...
                >
                  ...
                  <div className="flex justify-center items-center absolute w-full bottom-6">
                    <button variant="outlined" className="w-52 py-2 rounded-xl duration-200 group-hover:text-mp-white group-hover:bg-mp-violet">
                      Select Plan
                    </button>
                  </div>
                </div>
